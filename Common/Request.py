...
class Request:
    ...
    def get_request(self, url,data, header):
        ...
        try:
            if data is None:
                response =request.get(url=url,header=header,cookies=self.get_session)
    ...
    def post_request_multipart(self, url,data,header,file_parm, file, f_type):
        ...
        try:
            if data is None:
                response =request.post(url=url, header=header, cookies=self.get_session)
                ...
                response =request.post(url=url,params=data,header=header, cookies=self.get_session)
    ...
    def put_request(self, url, data, header):
        ...
        try:
            if data is None:
                response = request.put(url=url, headers=header, cookies=self.get_session)
            else:
                response = request.put(url=url, params=data, headers=header, cookies=self.get_session)
