...
class Config:
    ...
    def __init__(self):
        ...
        self.log=Log.MyLog()
        self.conf_path=os.path.join(os.path.dirname(os.path.abspath(__file__)),'config')
        ...
        self.environment_relese=self.get_conf(Config.TITLE_DEBUG,Config.VALUE_ENVIRONMENT)
        ...
        self.loginHost_debug=self.get_conf(Config.TITLE_DEBUG,Config.VALUE_HOST)
        ...
        self.environment_relese=self.get_conf(Config.TITLE_RELEASE,Config.VALUE_ENVIRONMENT)
        self.versionCode_relese=self.get_conf(Config.TITLE_RELEASE,Config.VALUE_VERSION_CODE)
        self.host_relese=self.get_conf(Config.TITLE_RELEASE,Config.VALUE_HOST)
        self.loginHost_relese=self.get_conf(Config.TITLE_RELEASE,Config.VALUE_LOGIN_HOST)
        self.loginInfo_relese=self.get_conf(Config.TITLE_RELEASE,Config.VALUE_LOGIN_INFO)
